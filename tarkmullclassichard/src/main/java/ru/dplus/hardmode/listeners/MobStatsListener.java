...
public class MobStatsListener implements Listener {
    ...
    public void onSpawn(CreatureSpawnEvent event) {
        ...
        if (isBoss) {
            ...
            damageMult = cfg.getDouble("skeleton-damage-multiplier", 1.8);
        } else {
            healthMult = cfg.getDouble("mob-health-multiplier", 2.0);
        ...
        if (entity instanceof Piglin && !(entity instanceof PiglinBrute)) {
            speedMult = cfg.getDouble("piglin-speed-multiplier", 1.2);
        } else if (isCreeper) {
            speedMult = cfg.getDouble("creeper-speed-multiplier", 1.2);
        } else {
            speedMult = cfg.getDouble("mob-speed-multiplier", 1.3);
        }
