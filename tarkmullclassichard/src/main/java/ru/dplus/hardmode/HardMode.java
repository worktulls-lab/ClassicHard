...
import ru.dplus.hardmode.commands.TarkCommand;
...
import ru.dplus.hardmode.listeners.PiglinAggroTask;
...
public final class HardMode extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new PassiveMobListener(this), this);
        getServer().getPluginManager().registerEvents(new FurnaceSlowdownListener(this), this);
        getServer().getPluginManager().registerEvents(new SpiderPoisonListener(this), this);

        IronGolemListener ironGolemListener = new IronGolemListener(this);
        getServer().getPluginManager().registerEvents(ironGolemListener, this);
        ironGolemListener.runTaskTimer(this, 10L, 10L);
        ...
        new PiglinAggroTask(this).runTaskTimer(this, 20L, 20L);

        var tarkCommand = getCommand("tark");
        if (tarkCommand != null) {
            tarkCommand.setExecutor(new TarkCommand(this));
        }
